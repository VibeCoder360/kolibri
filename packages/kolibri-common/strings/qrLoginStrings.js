...
export const qrLoginStrings = createTranslator('QRLoginStrings', {
  ...
  documentTitle: {
    ...
    context: 'Browser tab title for the QR sign-in page.',
  },
  scanQRCodeTitle: {
  ...
  qrTokenOperationFailed: {
    message: 'QR code operation failed. Please try again.',
    context: 'Error shown when rotating or assigning a QR token fails.',
  },
});
